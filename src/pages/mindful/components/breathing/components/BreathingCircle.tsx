...
export default function BreathingCircle({ currentStep, circleSize, exercise }: BreathingCircleProps) {
  ...
  return (
    <div className="relative flex items-center justify-center mb-8" style={{ height: isMobile ? '280px' : '320px' }}>
      <div className="absolute inset-0 flex items-center justify-center">
        ...
        {currentStep === "inhale" && (
          <motion.div
            ...
            initial={{ width: adjustedSize * 0.9, height: adjustedSize * 0.9, opacity: 0 }}
            animate={{ 
        ...
        {currentStep === "exhale" && (
          <motion.div
            ...
            initial={{ width: adjustedSize * 1.3, height: adjustedSize * 1.3, opacity: 0 }}
            animate={{ 
